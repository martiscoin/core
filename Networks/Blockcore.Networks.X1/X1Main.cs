...
namespace Blockcore.Networks.X1
{
    public class X1Main : Network
    {
        ...
        public string DevAddress { get { return "x11qv2nn7tvvkuy9lfaaksv850uzyzm6ygewwm3urw"; } }
        public decimal Devfee { get { return 0.1M; } }
        ...
        public X1Main()
        {
            ...
            this.DefaultPort = 11333; // new
            this.DefaultRPCPort = 13333; // new 
            this.DefaultAPIPort = 14334; // new
            ...
            this.FallbackFee = Money.Coins(0.000001m).Satoshi;
            this.MinRelayTxFee = Money.Coins(0.000001m).Satoshi;
            this.AbsoluteMinTxFee = Money.Coins(0.000001m).Satoshi;
            ...
            this.Consensus = new Blockcore.Consensus.Consensus(
                ...
                coinbaseMaturity: 15,//15 block confirm
                premineHeight: 0,
